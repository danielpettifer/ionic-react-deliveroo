  ...
  <IonApp>
    <IonReactRouter>
      <IonRouterOutlet>
        ...
        <Route path="/home/restaurantdetail/:id" component={RestaurantDetail} exact={true} />
        <Route path="/home/restaurantdetail/:id/menuitemdetail/:id" component={MenuItemDetail} exact={true} />
